...
export VERSION=v8.19.2-4

# Clone the source code repository
git clone https://github.com/RedMSG/RedTech.molly.git

# Go to this directory
cd RedTech.molly/reproducible-builds
...
wget https://github.com/RedMSG/RedTech.molly/releases/download/$VERSION/Ghostly-$VERSION.apk
...
If you get `APKs don't match`, please [report the issue](https://github.com/RedMSG/RedTech.molly/issues).
